...
public class FirstActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.multi_image_video_btn).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.multi_image_btn:
                ...
                break;
            case R.id.multi_image_video_btn:
                BoxingConfig imgVideoconfig = new BoxingConfig(BoxingConfig.Mode.MULTI_IMG).needCamera(R.drawable.ic_boxing_camera_white).needGif().needVideo();
                Boxing.of(imgVideoconfig).withIntent(this, BoxingActivity.class).start(this, REQUEST_CODE);
                //========yqy changed 2017-09-29===================
                break;
            case R.id.video_btn:
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof MediaViewHolder) {
               ...
               // mediaViewHolder.itemView.setTag(position);
                //使用Glide加载图片，不能设置Tag，否则两次加载，不会更新上一次已经加载过的
                //========yqy changed 2017-09-29===================
            }
        }
