...
public abstract class AbsBoxingViewFragment extends Fragment implements PickerContract.View {
     ...
     * call {@link #loadMedias()} or {@link #loadMedias(int, String,boolean)}, call {@link #loadAlbum()} if albums needed.
...
*/
    public final void loadMedias(int page, String albumId,boolean allVideo) {
        mPresenter.loadMedias(page, albumId,allVideo);
    }
    //========yqy changed 2017-09-29===================
