...
public class Boxing {
    ...
    static final String EXTRA_ALL_VIDEO = "com.bilibili.boxing.Boxing.all_video";
    ...
    public Boxing withIntent(Context context, Class<?> cls, ArrayList<? extends BaseMedia> medias, int pos, String albumId,boolean allVideo) {
        mIntent.setClass(context, cls);
        if (medias != null && !medias.isEmpty()) {
            mIntent.putExtra(EXTRA_SELECTED_MEDIA, medias);
        }
        ...
        mIntent.putExtra(EXTRA_ALL_VIDEO,allVideo);
        return this;
    }
    //========yqy changed 2017-09-29===================
