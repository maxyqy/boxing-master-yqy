...
public class ImageMedia extends BaseMedia implements Parcelable {
    ...
    //private boolean mIsSelected; //========yqy changed 2017-09-29===================
    ...
    public ImageMedia(Builder builder) {
        ...
        this.mDateAdd=builder.mDateAdd;//========yqy changed 2017-09-29===================
    }
    ...
    */
    ...
    public static class Builder {
        ...
        public Builder setDateAdd(long dateAdd) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        //dest.writeByte(this.mIsSelected ? (byte) 1 : (byte) 0);//========yqy changed 2017-09-29===================
    ...
    protected ImageMedia(Parcel in) {
        super(in);
        //this.mIsSelected = in.readByte() != 0;//========yqy changed 2017-09-29===================
