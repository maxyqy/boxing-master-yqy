...
public class BoxingConfig implements Parcelable {
    ...
    public enum Mode {
        SINGLE_IMG, MULTI_IMG, VIDEO, MULTI_ALL
        //========yqy changed 2017-09-29===================
    }
    ...
    public BoxingConfig needVideo(){
        if(this.isMultiImageMode()) {  //只有在图片多选Mode下才有效，所以先要设置图片模式，再设置needVideo
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.mNeedVideo ? (byte) 1 : (byte) 0);
        //========yqy changed 2017-09-29===================
