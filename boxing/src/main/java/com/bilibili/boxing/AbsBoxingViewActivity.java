...
public abstract class AbsBoxingViewActivity extends AppCompatActivity implements PickerContract.View {
    ...
    private void parseSelectedMedias(Bundle savedInstanceState, Intent intent) {
        if (savedInstanceState != null) {
            ...
            if(savedInstanceState.containsKey(Boxing.EXTRA_ALL_VIDEO)){
                mAllVideo=savedInstanceState.getBoolean(Boxing.EXTRA_ALL_VIDEO);
            }
            //========yqy changed 2017-09-29===================
        } else if (intent != null) {
            ...
            if(intent.hasExtra(Boxing.EXTRA_ALL_VIDEO)){
                mAllVideo=intent.getBooleanExtra(Boxing.EXTRA_ALL_VIDEO,false);
            }
            //========yqy changed 2017-09-29===================
        }
    }
    ...
    public final void loadMedias() {
        ...
        mPresenter.loadMedias(0, AlbumEntity.DEFAULT_NAME,false);
        //========yqy changed 2017-09-29===================
    }
    ...
    public final void loadMedias(int page, String albumId) {
        ...
        mPresenter.loadMedias(page, albumId,mAllVideo);
        //========yqy changed 2017-09-29===================
    }
