...
public class PickerPresenter implements PickerContract.Presenter {
  ...
  /*  @Override
    ...
    */
  @Override
  public void loadMedias(int page, String albumId,boolean allVideo) {
      mCurrentAlbumId = albumId;
      mAllVideo=allVideo;
      if (page == 0) {
          mTasksView.clearMedia();
      ...
      ContentResolver cr = mTasksView.getAppCr();
      BoxingManager.getInstance().loadMedia(cr, page, albumId,allVideo, mLoadMediaCallback);
  }
    //========yqy changed 2017-09-29===================
    ...
    public void onLoadNextPage() {
        ...
        loadMedias(mCurrentPage, mCurrentAlbumId,mAllVideo);
        //========yqy changed 2017-09-29===================
    }
    ...
    public void checkSelectedMedia(List<BaseMedia> allMedias, List<BaseMedia> selectedMedias) {
        ...
        Map<String, BaseMedia> map = new HashMap<>(allMedias.size());
        //========yqy changed 2017-09-29===================
